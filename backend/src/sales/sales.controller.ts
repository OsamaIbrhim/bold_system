...
export class SalesController {
  constructor(private svc: SalesService, private pdf: InvoicePdfService, private prisma: PrismaService) {}
  ...
  async pdf(@Param('id') id: string, @Query('lang') lang: 'ar'|'en' = 'ar', @Res() res: Response) {
    ...
    const buf = await this.pdf.render(invoice, lang);
